 ...
 */
void *pool_alloc(mem_pool_t *restrict const pool);
 ...
 */
void pool_free(mem_pool_t *restrict const pool, void *restrict const ptr);
 ...
 */
void pool_destroy(mem_pool_t *restrict const pool);
